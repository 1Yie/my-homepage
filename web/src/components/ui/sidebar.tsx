...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
	...
	return (
		<button
			...
			className={cn(
				`-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0
				z-20 hidden w-4 transition-all ease-linear after:absolute
				after:inset-y-0 after:left-1/2 after:w-[2px]
	...
	return (
		<main
			className={cn(
				...
				md:peer-data-[variant=inset]:shadow-sm/5`,
				className
			)}
	...
	return (
		<div
			className={cn(
				...
				items-center justify-center rounded-lg px-1 font-medium
				text-sidebar-foreground text-xs tabular-nums`,
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
	return (
		<ul
			className={cn(
				`mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-sidebar-border

...
function Toasts({ position = 'bottom-right' }: { position: ToastPosition }) {
	...
	return (
		<Toast.Portal data-slot="toast-portal">
			<Toast.Viewport
				className={cn(
					`fixed z-50 mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-90
					...
					return (
						<Toast.Root
							className={cn(
								...
								bg-popover not-dark:bg-clip-padding text-popover-foreground
								shadow-lg/5
						...
						>
							<Toast.Content
								className="pointer-events-auto flex items-center justify-between
									...
									duration-250 data-behind:pointer-events-none

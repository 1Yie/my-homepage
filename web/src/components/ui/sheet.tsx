			...
			<SheetViewport inset={inset} side={side}>
				<SheetPrimitive.Popup
					className={cn(
						...
						before:inset-0 before:shadow-[0_1px_--theme(--color-black/6%)]
						data-ending-style:opacity-0 data-starting-style:opacity-0
						max-sm:before:hidden
						dark:before:shadow-[0_-1px_--theme(--color-white/6%)]`,
						side === 'bottom' &&
							`row-start-2 border-t data-ending-style:translate-y-8
							data-starting-style:translate-y-8`,
						side === 'top' &&
							`data-ending-style:-translate-y-8
							data-starting-style:-translate-y-8 border-b`,
						side === 'left' &&
							`data-ending-style:-translate-x-8
							data-starting-style:-translate-x-8 w-[calc(100%-(--spacing(12)))]
							max-w-md border-e`,
						side === 'right' &&
							`col-start-2 w-[calc(100%-(--spacing(12)))] max-w-md border-s
							data-ending-style:translate-x-8 data-starting-style:translate-x-8`,
						inset &&
							`before:hidden sm:rounded-2xl sm:border
	...
	return (
		<div
			className={cn(
				...
				variant === 'bare' &&
					`in-[[data-slot=sheet-popup]:has([data-slot=sheet-panel])]:pt-3 pt-4
					pb-6`,
				className
			)}
...
function SheetPanel({
	...
	return (
		<ScrollArea scrollFade={scrollFade}>
			<div
				className={cn(
					`px-6 in-[[data-slot=sheet-popup]:has([data-slot=sheet-header])]:pt-1

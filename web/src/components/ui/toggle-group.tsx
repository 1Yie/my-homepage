		...
		<ToggleGroupPrimitive
			className={cn(
				...
				variant === 'default'
					? 'gap-0.5'
					: orientation === 'horizontal'
						? `*:not-first:not-data-[slot=separator]:before:-start-[0.5px]
							*:not-last:not-data-[slot=separator]:before:-end-[0.5px]
							*:not-first:rounded-s-none *:not-last:rounded-e-none
							*:not-first:border-s-0 *:not-last:border-e-0
						...
						: `*:not-first:not-data-[slot=separator]:before:-top-[0.5px]
							*:not-last:not-data-[slot=separator]:before:-bottom-[0.5px]
							flex-col *:not-first:rounded-t-none *:not-last:rounded-b-none
							*:not-first:border-t-0 *:not-last:border-b-0
							*:not-first:before:rounded-t-none *:not-last:before:rounded-b-none
...
function ToggleGroupSeparator({
	...
	return (
		<Separator
			className={cn(
				`pointer-events-none relative before:absolute before:inset-0

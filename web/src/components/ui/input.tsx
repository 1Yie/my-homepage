		...
		>
			<InputPrimitive
				className={cn(
					...
					leading-8.5 outline-none placeholder:text-muted-foreground/72 sm:h-7.5
					sm:leading-7.5`,
					size === 'sm' &&
						`h-7.5 px-[calc(--spacing(2.5)-1px)] leading-7.5 sm:h-6.5
						sm:leading-6.5`,
					...
					props.type === 'file' &&
						`text-muted-foreground file:me-3 file:bg-transparent
